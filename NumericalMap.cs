...
{
    /// <summary>
    ///   This hashmap (hence the name) is heavily optimized to be used with numerical keys 
    ...
    /// - fibonacci hashing
    /// </summary>
    public class NumericalMap<TKey, TValue> where TKey : unmanaged, IComparable, IEquatable<TKey>
    {
        #region properties
        ...
        public NumericalMap(uint length = 16, double loadFactor = 0.88d)
        {
