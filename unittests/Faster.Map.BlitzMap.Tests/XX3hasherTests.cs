...
{
    private BlitzMap<string, int, XxHash3Hasher.String> _map;

    public XX3hasherStringTests()
    {
        _map = new BlitzMap<string, int, XxHash3Hasher.String>(4);
    }
    ...
    {
        _map = new BlitzMap<string, int, XxHash3Hasher.String>(4, 0.8);
