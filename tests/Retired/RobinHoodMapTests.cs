...
{
    [TestClass]
    public class RobinHoodMapTests
    {
        private uint[] keys;
        ...
        public void AssertDailyUseCaseWithoutResize()
        {
            for (int i = 0; i < 100; i++)
            {
                var fmap = new RobinHoodMap<uint, uint>(1000000);
        ...
        {
            var fmap = new RobinHoodMap<uint, uint>(16);
        ...
        {
            //arrange
            var map = new RobinHoodMap<uint, uint>(16);
        ...
        {
            //arrange
            var map = new RobinHoodMap<uint, uint>(1000000);
        ...
        {
            var map = new RobinHoodMap<uint, uint>(16);
            var map2 = new RobinHoodMap<uint, uint>(16);
        ...
        public void AssertCustomSize()
        {
            for (int i = 0; i < 100; i++)
            {
                ...
                var map = new RobinHoodMap<uint, uint>(1000000, 0.9);
        ...
        {
            var map = new RobinHoodMap<StringWrapper, StringWrapper>(16, 0.5);
        ...
        {
            //assign
            var map = new RobinHoodMap<uint, uint>(16, 0.5);
